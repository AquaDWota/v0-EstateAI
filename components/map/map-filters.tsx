      ...
      <div className="flex items-center gap-2 rounded-lg bg-card p-2 shadow-lg">
        <div className="flex items-center gap-2 rounded-md bg-background px-3 py-2">
          ...
          <Input
            ...
            className="h-8 w-24 border-0 bg-transparent p-0 text-sm font-mono focus-visible:ring-0"
          />
        </div>
        <Button size="sm" onClick={handleZipSubmit} className="h-9 px-3">
        ...
        <Popover open={isFiltersOpen} onOpenChange={setIsFiltersOpen}>
          <PopoverTrigger asChild>
            <Button
              size="sm"
              variant="outline"
              className="relative h-9 gap-2 bg-transparent"
            >
